        ...
        <div id="disco" className="disco">
            ...
            <div className="disco-item-flex">
              ...
              <div className="disco-item-text">
                <p className="disco-item-highlight">
                  ...
                  dvojitou DESKOU ROKU v publicistických cenách Břitva! Račte
                  toto libé album poslouchat a stahovat na Bandcampu nebo si CD
                  můžete objednat coby úchvatný artefakt (na vyžádání i s
                  podpisy) přes {''}
          ...
          <div className="disco-item">
            ...
            <div className="disco-item-flex">
              <div className="disco-item-img">
                ...
                <p>
                  Album bylo natočeno v lednu až říjnu 2013 ve studiích Entlaab
                  a ŠOPA. O mix a mastering se postaral Standa Valášek ze{' '}
              ...
              <div className="disco-item-text">
                ...
                <div className="disco-item-credits">
                  <p>
                    <span className="disco-item-span1">Produkce:</span> První
                    Hoře
                  </p>
                  <p>
                    <span className="disco-item-span1">Mix a mastering:</span>{' '}
          ...
          <div className="disco-item">
            ...
            <div className="disco-item-flex">
              ...
              <div className="disco-item-text">
                <p>
                  Deska byla natočena v lednu až květnu 2008 ve studiích Entlaab
                  a{' '}
                  <a href="https://studiohostivar.cz/#" target="_blank">
                    Hostivař
                  </a>{' '}
                  ...
                  <a href="https://www.velvetmastering.com/">
                    Velvet Mastering
                  </a>{' '}
            ...
            <div className="disco-item-flex">
              ...
              <div className="disco-item-text">
                <p>
                  ...
                  . Na CD účinkuje několik hostů, ozvláštněním jsou zejména
                  housle Ondřeje Koláčného.
                </p>
                <div className="disco-item-credits"></div>
              </div>
            </div>
